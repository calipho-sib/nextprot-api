...
public class GitHubServiceImpl implements GitHubService {
	...
	public String getPage(String page) {
		...
		// Not sure if this keeps a connection (if not this can be done on the postconstruct)
		try {
			...
			throw new NextProtException("Documentation not available, try to fix this soon");
		}
