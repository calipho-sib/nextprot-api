...
public class StreamEntryServiceImpl implements StreamEntryService {
    ...
    @Override
    public void streamEntries(Collection<String> accessions, NextprotMediaType format, String viewName, OutputStream os) throws IOException {
    ...
    public void streamQueriedEntries(QueryRequest queryRequest, NextprotMediaType format, String viewName, HttpServletResponse response) {
        ...
        try {
            ...
            streamEntries(entries, format, viewName, response.getOutputStream());
        }
        catch (IOException e) {
