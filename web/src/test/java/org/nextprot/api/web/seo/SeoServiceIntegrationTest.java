...
public class SeoServiceIntegrationTest extends WebIntegrationBaseTest {
	...
	public void testSomeHardCodedTags() throws Exception {
		SeoTags tags;
		tags = seoTagsService.getSeoTags("/about/nextprot");
	...
	public void testSomeDefaultSeoTags() throws Exception {
		...
		tags = seoTagsService.getSeoTags("/toto");
		Assert.assertTrue(tags!=null);
		...
		tags = seoTagsService.getSeoTags("/toto/tutu");
		Assert.assertTrue(tags!=null);
		Assert.assertEquals("Toto - Tutu", tags.getTitle());
		
		tags = seoTagsService.getSeoTags("/toto/tutu?titi=content");
		Assert.assertTrue(tags!=null);
		Assert.assertEquals("Toto - Tutu", tags.getTitle());
	...
	public void testSeoTagsForNews() throws Exception {
		...
		tags = seoTagsService.getSeoTags("/news");
		Assert.assertTrue(tags!=null);
		...
		tags = seoTagsService.getSeoTags("/news/the-nextprot-hupo2014-release");
		Assert.assertTrue(tags!=null);
	...
	public void testSeoTagsForEntry() throws Exception {
		...
		tags = seoTagsService.getSeoTags("/entry/NX_P01308");
		Assert.assertTrue(tags!=null);
		...
		tags = seoTagsService.getSeoTags("/entry/NX_P01308/function");
		Assert.assertTrue(tags!=null);
		Assert.assertEquals("INS - Insulin - Function", tags.getTitle());
		
		tags = seoTagsService.getSeoTags("/entry/NX_P01308/medical");
		Assert.assertTrue(tags!=null);
		Assert.assertEquals("INS - Insulin - Medical", tags.getTitle());
		
		tags = seoTagsService.getSeoTags("/entry/NX_P01308/expression");
		Assert.assertTrue(tags!=null);
	...
	public void testSeoTagsForPubli() throws Exception {
		SeoTags tags;
		tags = seoTagsService.getSeoTags("/publication/43778635");
		Assert.assertTrue(tags!=null);
		...
		// just check that we have same tag with this url
		tags = seoTagsService.getSeoTags("/publication/43778635/proteins");
		Assert.assertTrue(tags!=null);
		Assert.assertEquals(title, tags.getTitle());
	...
	public void testSeoTagsForTerm() throws Exception {
		...
		tags = seoTagsService.getSeoTags("/term/GO:0042802");
		Assert.assertTrue(tags!=null);
		...
		tags = seoTagsService.getSeoTags("/term/GO:0042802/proteins");
		Assert.assertTrue(tags!=null);
		Assert.assertEquals(baseTitle + "Proteins", tags.getTitle());
		

		tags = seoTagsService.getSeoTags("/term/GO:0042802/ancestors");
		Assert.assertTrue(tags!=null);
		Assert.assertEquals(baseTitle + "Ancestors", tags.getTitle());
		
		tags = seoTagsService.getSeoTags("/term/GO:0042802/tree");
		Assert.assertTrue(tags!=null);
