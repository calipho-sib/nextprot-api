...
public class NPEntryXMLStreamWriterTest extends WebIntegrationBaseTest {
    ...
    public void testWriteXML() throws Exception {
		...
		String expectedXmlOutput2 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
				"<nextprot-export>\n" +
				"    <header>\n" +
				"        <database-name>neXtProt</database-name>\n" +
				"        <number-of-entries>$entriesCount</number-of-entries>\n" +
        ...
        Assert.assertTrue(expectedXmlOutput.equals(out.toString()) || expectedXmlOutput2.equals(out.toString()));
    }
