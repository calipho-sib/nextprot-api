...
public class ExperimentalContextDaoImpl implements ExperimentalContextDao {
	...
	public List<ExperimentalContext> findExperimentalContextsByIds(List<String> ids) {
		...
		return new NamedParameterJdbcTemplate(dsLocator.getDataSource()).query(getSQLQuery("experimental-contexts-by-ids"), namedParameters, new EcRowMapper());
	}

	@Override
	public List<ExperimentalContext> findAllExperimentalContexts() {
		SqlParameterSource namedParameters = new MapSqlParameterSource();
		return new NamedParameterJdbcTemplate(dsLocator.getDataSource()).query(getSQLQuery("experimental-contexts-all"), namedParameters, new EcRowMapper());
	}
