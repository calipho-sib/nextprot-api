...
import org.nextprot.api.core.utils.dbxref.DbXrefLogger;
 ...
 */
	...
	public void logAllEntriesXrefUrlStatus() throws IOException {
		...
		DbXrefLogger logger = new DbXrefLogger("/tmp/allentries-xrefs-url.tsv", "/tmp/allentries-xrefs-url.log");

		for (String entryAc : allEntryAcs) {

			logger.append(entryAc, this.xrefService.findDbXrefsByMaster(entryAc));
		}
