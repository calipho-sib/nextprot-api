...
public class EntryPartExporterImplTest extends CoreUnitBaseTest {
    ...
    public void getDefaultHeaders() throws Exception {
        ...
        Assert.assertEquals(9, headers.size());
    }

    @Test
    public void add1Column() throws Exception {

        EntryPartExporter exporter = new EntryPartExporterImpl.Builder().addColumn(Header.CELL_LINE_ACCESSION).build();
    ...
    public void add1AlreadyExistingColumn() throws Exception {
        ...
        EntryPartExporter exporter = new EntryPartExporterImpl.Builder().addColumn(Header.ENTRY_ACCESSION).build();
    ...
    public void getColumnsForEntryNX_P01308() throws Exception {
        ...
        Assert.assertEquals(9, rows.get(0).size());
    }
}