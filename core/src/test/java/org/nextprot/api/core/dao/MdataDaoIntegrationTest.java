...
public class MdataDaoIntegrationTest extends CoreUnitBaseTest {
	...
	@Test
	public void should_Find_Non_Empty_Evidence_Mdata_Map_And_Corresponding_Mdata_Records_For_NX_Q99622() {
	...
	// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 	
	// tests related to queries useful for getting sample evidences
	// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 	
