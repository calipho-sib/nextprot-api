...
public class UcscXrefURLResolverTest {
    ...
    public void testResolveUCSCMissingPlaceHolder1() throws Exception {
        ...
        DbXref xref = createDbXref("uc004fjp.3", "UCSC", "http://genome.ucsc.edu/cgi-bin/hgGene?hgg_gene=%s1");
    ...
    public void testResolveUCSCMissingPlaceHolder2() throws Exception {
        ...
        DbXref xref = createDbXref("uc004fjp.3", "UCSC", "http://genome.ucsc.edu/cgi-bin/hgGene?org=%s2");
