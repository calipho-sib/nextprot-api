...
public enum CvDatabasePreferredLink {
	...
	BGEE(ReleaseDataSources.Bgee.getUrl()+"?page=gene&gene_id=%s"),
	...
	EMBL_GENE("https://www.ebi.ac.uk/ena/browser/view/%s"),
	EMBL_PROTEIN("https://www.ebi.ac.uk/ena/browser/view/%s"),
	...
	INTACT_BINARY("https://www.ebi.ac.uk/intact/search?query=(id:%s1%20AND%20id:%s2)#interactor"),
