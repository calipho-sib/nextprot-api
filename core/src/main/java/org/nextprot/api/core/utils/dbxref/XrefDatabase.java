...
public enum XrefDatabase implements EnumDictionarySupplier<XrefDatabase> {
    ...
    KEGG(), KO(),
    LOC(),
    MALA_CARDS("MalaCards"), MAX_QB("MaxQB"), MEROPS(), MGI(), MIM(), MINT(),
    NEXT_BIO("NextBio"), NIH_ARP("NIH-ARP"),
    MOON_PROT("MoonProt"),
    OBO(), OGP(), OMA(), OPEN_TARGETS("OpenTargets"), ORTHO_DB("OrthoDB"),
    ...
    PIRSF(), PMAP_CUT_DB("PMAP-CutDB"), PRIDE(), PRINTS(), PRO(), PRO_DOM("ProDom"), PROSITE(),
    PROSITE_PRORULE("PROSITE-ProRule"), PROTEIN_MODEL_PORTAL("ProteinModelPortal"), PROTEOMES("Proteomes"), PROTEOPEDIA(),
