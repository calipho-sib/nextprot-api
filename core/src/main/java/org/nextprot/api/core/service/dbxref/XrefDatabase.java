...
public enum XrefDatabase implements EnumDictionarySupplier<XrefDatabase> {
    ...
    GERM_ONLINE("GermOnline"), GLYGEN("GlyGen"), GLY_CONNECT("GlyConnect"), GUIDETO_PHARMOCOLOGY("GuidetoPHARMACOLOGY"),
    ...
    SABIO_RK("SABIO-RK"), SASBDB, SFLD, SIGNA_LINK("SignaLink"), SIGNOR, SMART, SMR, SRM_ATLAS("SRMAtlas"), STRING,
