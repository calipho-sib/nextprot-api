...
public class SequencePageView extends PageViewBase {
	...
	protected List<XrefDatabase> getXrefDatabaseWhiteList() {
		return Arrays.asList(
				...
				PROSITE, SFLD, SMART, SUPFAM, TIGRFAMS,
				
				// GENOME ANNOTATION DATABASES
				ENSEMBL, KEGG, MANE_SELECT, UCSC,
				
				// ORGANISM-SPECIFIC DATABASES
				AGR, MGI, VEU_PATH_DB,
				
				// OTHER
				CHITARS, EVOLUTIONARY_TRACE, PIRNR, PMAP_CUT_DB, PIRSR, SAM,
				
				// PTM DATABASES
				DEPOD, I_PTM_NET, PHOSPHO_SITE_PLUS, SWISS_PALM, UNI_CARB_KB, GLYGEN, GLY_CONNECT, CARBONYL_DB, METOSITE,
				
				// PHYLOGENOMIC DATABASES
				EGG_NOG, GENE_TREE, HOGENOM, IN_PARANOID, KO, OMA, ORTHO_DB, PHYLOM_DB, TREE_FAM,
