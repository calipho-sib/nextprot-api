select cv_name, description, url, release_version, internal_update_date as last_import
...
and cv_name in('UniProtKB', 'BGee', 'Cosmic', 'PubMed publications', 'GO annotations', 'Human SRMAtlas', 'PROSITEDOC', 'MeSH')
