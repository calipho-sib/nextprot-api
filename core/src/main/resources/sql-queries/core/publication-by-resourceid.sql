select 
  ...
  (select rp2.property_value from nextprot.resource_properties rp2 where rp2.resource_id=pubs.resource_id and rp2.property_name='country') as country,
  (select rp2.property_value from nextprot.resource_properties rp2 where rp2.resource_id=pubs.resource_id and rp2.property_name='institute') as institute,
