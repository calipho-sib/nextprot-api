...
ct.cv_name as name_type, qt.cv_name as name_qualifier, asy.is_main, asy.synonym_name, ('MP_' ||asy.synonym_id)::text as synonym_id, ('MP_' || asy.parent_id)::text as parent_id
