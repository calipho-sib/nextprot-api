...
t2.cv_id as cv_term_id,  
t2.cv_name cv_term_name, 
term_type.cv_name cv_term_type,
x.accession cv_term_accession,   
...
where t.cv_name not in ( 'family name', 'alignment conflict')  
