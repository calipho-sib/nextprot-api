select props.pe as pe, coalesce(props.ptm_num, -1) as ptmcnt, props.isoform_num as isocnt, coalesce(props.var_num, -1) as varcnt, coalesce(props.mutagenesis_num, -1) as mutcnt,
