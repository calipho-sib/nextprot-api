...
interactant_url 
	...
	and asp.assoc_id is null or (asp.assoc_id > ppa.assoc_id) -- removes doublons (same interaction with interactants in reverse order)
	...
	-- where partnership_id=71984 -- self-interaction (1 line expected)
	-- where partnership_id=75404 -- dual-interaction (1 line expected)
	-- where entry_name = 'NX_P06213'
	-- where entry_name = 'NX_P01308'
