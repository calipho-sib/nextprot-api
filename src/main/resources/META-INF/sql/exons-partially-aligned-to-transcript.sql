 ...
 */
select sig.unique_name gene_name, sit.unique_name transcript_name, sie.unique_name exon, (mp_ig.first_pos + 1) first_position, mp_ig.last_pos last_position, (ma_et.rank - 1) rank
