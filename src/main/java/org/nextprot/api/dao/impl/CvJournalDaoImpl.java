...
import org.nextprot.api.dao.CvJournalDao;
...
public class CvJournalDaoImpl implements CvJournalDao {
	...
	public CvJournal findById(Long journalId) {
		...
		return new NamedParameterJdbcTemplate(dsLocator.getDataSource()).queryForObject(getSQLQuery("cvjournal-by-id"), params, new JournalRowMapper());
	}
	...
	public List<CvJournal> findByPublicationId(Long publicationId) {
		...
		return new NamedParameterJdbcTemplate(dsLocator.getDataSource()).query(getSQLQuery("cvjournal-by-publication-id"), params, new JournalRowMapper());
	}	
	...
	public List<PublicationCvJournal> findCvJournalsByPublicationIds(List<Long> publicationIds) {
		...
		return new NamedParameterJdbcTemplate(dsLocator.getDataSource()).query(getSQLQuery("cvjournal-by-publication-ids"), params, new PublicationCvJournalRowMapper());
	}
