...
public class SequenceVariationHGVSParseDeletionTest {
    ...
    public void testParseAANonStandardDeletion1() throws Exception {
        ...
        SequenceVariation pm = format.parse("p.K487_L498del12", ProteinSequenceVariationHGVSFormat.ParsingMode.PERMISSIVE);
    ...
    public void testParseAANonStandardDeletion2() throws Exception {
        ...
        SequenceVariation pm = format.parse("p.K487_L498delPRAL", ProteinSequenceVariationHGVSFormat.ParsingMode.PERMISSIVE);
