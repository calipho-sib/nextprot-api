...
public class SequenceVariationHGVSParseDelinsTest {
    ...
    public void testParseAANonStandardDelins1() throws Exception {
        ...
        SequenceVariation pm = format.parse("p.T399>L", ProteinSequenceVariationHGVSFormat.ParsingMode.PERMISSIVE);
    ...
    public void testParseAANonStandardDelins2() throws Exception {
        ...
        SequenceVariation pm = format.parse("p.L330_A331>F", ProteinSequenceVariationHGVSFormat.ParsingMode.PERMISSIVE);
    ...
    public void testParseAANonStandardDelins3() throws Exception {
        ...
        SequenceVariation pm = format.parse("p.W39_E40>*", ProteinSequenceVariationHGVSFormat.ParsingMode.PERMISSIVE);
    ...
    public void testParseAANonStandardDelins4() throws Exception {
        ...
        SequenceVariation pm = format.parse("p.D419_R420>SSDG", ProteinSequenceVariationHGVSFormat.ParsingMode.PERMISSIVE);
