...
public enum Xref2Annotation  {
	...
	DRUGBANK("DrugBank", "generic name", AnnotationCategory.SMALL_MOLECULE_INTERACTION.getDbAnnotationTypeName(),
			"DrugBank","SILVER","curated","IC","ECO:0000305", "curator inference used in manual assertion", true),
	...
	private final boolean usesBioObject;
    ...
    Xref2Annotation(final String xrefDbName,
		...
		this.usesBioObject=false;
	}
		
    Xref2Annotation(final String xrefDbName,
			final String xrefPropName, final String annotCat, final String srcName,
			final String qualityQualifier, final String assignMethod, final String qualifierType, String ecoAC, String ecoName, boolean useBioObject) {
		...
		this.ecoAC=ecoAC;
		this.ecoName=ecoName;
		this.usesBioObject=true;
	}
		
	public boolean usesBioObject() {
		return usesBioObject;
	}
