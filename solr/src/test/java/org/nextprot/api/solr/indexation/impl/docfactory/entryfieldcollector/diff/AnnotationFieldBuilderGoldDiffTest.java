...
public class AnnotationFieldBuilderGoldDiffTest extends SolrDiffTest {
	...
	public void testGoldAnnotations(Entry entry) {
		...
		// Expression
		org.nextprot.api.solr.indexation.impl.docfactory.entryfieldcollector.ExpressionSolrFieldCollector efb = new org.nextprot.api.solr.indexation.impl.docfactory.entryfieldcollector.ExpressionSolrFieldCollector();
		...
		if(expectedInteractions != null) {
			...
			org.nextprot.api.solr.indexation.impl.docfactory.entryfieldcollector.InteractionSolrFieldCollector ifb = new org.nextprot.api.solr.indexation.impl.docfactory.entryfieldcollector.InteractionSolrFieldCollector();
		...
		org.nextprot.api.solr.indexation.impl.docfactory.entryfieldcollector.CVSolrFieldCollector cfb = new org.nextprot.api.solr.indexation.impl.docfactory.entryfieldcollector.CVSolrFieldCollector();
