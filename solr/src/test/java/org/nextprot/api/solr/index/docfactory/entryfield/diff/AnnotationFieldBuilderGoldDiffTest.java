...
public class AnnotationFieldBuilderGoldDiffTest extends SolrDiffTest {
	...
	public void testGoldAnnotations(Entry entry) {
		...
		// Variants
		org.nextprot.api.solr.index.docfactory.entryfield.AnnotationSolrFieldCollector afb = new org.nextprot.api.solr.index.docfactory.entryfield.AnnotationSolrFieldCollector();
		...
		// Expression
		org.nextprot.api.solr.index.docfactory.entryfield.ExpressionSolrFieldCollector efb = new org.nextprot.api.solr.index.docfactory.entryfield.ExpressionSolrFieldCollector();
		...
		if(expectedInteractions != null) {
			...
			org.nextprot.api.solr.index.docfactory.entryfield.InteractionSolrFieldCollector ifb = new org.nextprot.api.solr.index.docfactory.entryfield.InteractionSolrFieldCollector();
		...
		org.nextprot.api.solr.index.docfactory.entryfield.CVSolrFieldCollector cfb = new org.nextprot.api.solr.index.docfactory.entryfield.CVSolrFieldCollector();
