package org.nextprot.api.solr.index.docfactory.entryfield.diff;
...
import org.nextprot.api.solr.index.docfactory.entryfield.SolrDiffTest;
...
public class PublicationCoreFullDiffTest extends SolrDiffTest {
	...
	public void testPublicationData(long pubid) {
		...
		String expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.TYPE);
		//System.err.println("type: " + expected);
		Assert.assertEquals(expected, solrDoc.getFieldValue("type"));
		
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.FILTERS);
		...
		expected = new DateFormatter().format((Date) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.DATE), DateFormatter.DAY_PRECISION);
		...
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.YEAR);
		//System.err.println("year: " + expected);
		Assert.assertEquals(expected, solrDoc.getFieldValue("year"));
		
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.VOLUME);
		System.err.println("volume: " + solrDoc.getFieldValue("volume"));
		Assert.assertEquals(expected, solrDoc.getFieldValue("volume"));
		
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.FIRST_PAGE);
		//System.err.println("first_page: " + expected);
		Assert.assertEquals(expected, solrDoc.getFieldValue("first_page"));
		
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.LAST_PAGE);
		//System.err.println("last_page: " + expected);
		Assert.assertEquals(expected, solrDoc.getFieldValue("last_page"));
		
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.JOURNAL);
		//System.err.println("journal: " + expected);
		Assert.assertEquals(expected, solrDoc.getFieldValue("journal"));
		
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.PRETTY_JOURNAL);
		//System.err.println("pretty_journal: " + expected);
		Assert.assertEquals(expected, solrDoc.getFieldValue("pretty_journal"));
		
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.TITLE);
		...
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.ABSTRACT);
		//System.err.println("abstract: " + expected);
		Assert.assertEquals(expected, solrDoc.getFieldValue("abstract"));
		
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.AC);
		...
		if(getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.AUTHORS) != null) // Some publis have no authors
		{
		List<String> authorList = (List) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.AUTHORS);
		...
		expected = (String) getValueForFieldInCurrentSolrImplementation(entry, PublicationSolrField.PRETTY_AUTHORS);
