...
public class AnnotationFieldBuilderGoldDiffTest extends SolrDiffTest {
	...
	public void testGoldAnnotations(Entry entry) {
		...
		// Expression
		org.nextprot.api.solr.indexation.docfactory.entryfield.ExpressionSolrFieldCollector efb = new org.nextprot.api.solr.indexation.docfactory.entryfield.ExpressionSolrFieldCollector();
		...
		if(expectedInteractions != null) {
			...
			org.nextprot.api.solr.indexation.docfactory.entryfield.InteractionSolrFieldCollector ifb = new org.nextprot.api.solr.indexation.docfactory.entryfield.InteractionSolrFieldCollector();
		...
		org.nextprot.api.solr.indexation.docfactory.entryfield.CVSolrFieldCollector cfb = new org.nextprot.api.solr.indexation.docfactory.entryfield.CVSolrFieldCollector();
