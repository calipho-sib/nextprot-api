...
public class GoldAndSilverEntryCoreImpl extends RealSolrCoreNew {

	private static final String NAME = "npentries1";

	public GoldAndSilverEntryCoreImpl(String solrServerUrl) {

		this(NAME, Alias.Entry, solrServerUrl);
	}

	protected GoldAndSilverEntryCoreImpl(String name, Alias alias, String solrServerUrl) {
