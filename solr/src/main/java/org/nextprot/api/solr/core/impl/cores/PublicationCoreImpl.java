...
public class PublicationCoreImpl extends RealSolrCoreNew {

	private static final String NAME = "nppublications1";

	public PublicationCoreImpl(String solrServerUrl) {

		super(PublicationCoreImpl.NAME, Alias.Publication, solrServerUrl);
	}
