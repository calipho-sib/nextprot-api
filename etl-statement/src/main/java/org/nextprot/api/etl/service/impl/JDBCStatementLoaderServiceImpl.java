...
public class JDBCStatementLoaderServiceImpl implements StatementLoaderService {
	...
	@Override
	public void loadRawStatementsForSource(Collection<Statement> statements, StatementSourceEnum source) throws SQLException {
		load(statements, rawTable, source);
	}

	@Override
	public void loadStatementsMappedToEntrySpecAnnotationsForSource(Collection<Statement> statements, StatementSourceEnum source) throws SQLException {
		load(statements, entryTable, source);
	}
	
	private void load(Collection<Statement> statements, String tableName, StatementSourceEnum source) throws SQLException {
