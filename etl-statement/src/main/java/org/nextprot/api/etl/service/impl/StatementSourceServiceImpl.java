...
public class StatementSourceServiceImpl implements StatementSourceService {
	...
	@Override
	public Set<String> getJsonFilenamesForRelease(StatementSourceEnum source, String release) throws IOException {
	...
	@Override
	public String getStatementsAsJsonArray(StatementSourceEnum source, String release, String jsonFileName) throws IOException {
